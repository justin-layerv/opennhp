...
// newTestConnTrackMap creates a real in-kernel HASH map matching the
...
// v6 test file) newTestConnTrackMapV6: it creates a real in-kernel HASH map
...
// tuple is intentionally natural-aligned at 16 bytes is documented in full in
