...
lint-workflows:
	...
	@python3 -m py_compile .github/scripts/check-relay-dmz-plan-https.py
	...
	@python3 tests/scripts/test_check_relay_dmz_plan_https.py
	@python3 tests/scripts/test_check_relay_dmz_plan_transition.py
