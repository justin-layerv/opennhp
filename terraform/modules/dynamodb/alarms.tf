# CloudWatch alarms on the bootstrap-path DynamoDB tables. Scope is
# limited to the two tables the customer-facing v1 ship hits on the
# hot path.
#
...
#
# Other DDB tables (qurl-webhooks-*, qurl-tunnels-*, etc.) are not in
# scope here — they aren't on the customer-install hot path. Add
# additional alarms in this file when those surfaces become customer-
# visible.
#
