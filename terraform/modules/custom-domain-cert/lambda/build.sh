...
echo "============================================"
echo "Building Custom Domain Cert Manager Lambda"
echo "============================================"
...
cp "${SCRIPT_DIR}/custom_domain_cert_manager.py" "${BUILD_DIR}/"
...
if [[ ! -f "${BUILD_DIR}/custom_domain_cert_manager.py" ]]; then
