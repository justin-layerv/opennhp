...
func TestIOSRetireSessionWrapperReturnsStrictRouteDenial(t *testing.T) {
	dir := t.TempDir()
	...
	knockAck, _ := json.Marshal(value)
	raw := NhpAgentRetireSession(string(knockAck), "999.999.999.999", "", common.DefaultNHPPort)
