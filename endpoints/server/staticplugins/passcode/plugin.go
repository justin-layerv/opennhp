...
// New creates a new passcode plugin instance
...
// RequestOTP handles OTP requests (not implemented for passcode plugin)
...
// RegisterAgent handles agent registration (not implemented for passcode plugin)
...
// ListService handles service listing (not implemented for passcode plugin)
