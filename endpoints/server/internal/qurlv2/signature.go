...
var (
	...
	ErrSignatureMalformedDER = errors.New("qurlv2: malformed ASN.1 DER ECDSA signature")
)
...
// signer-side conversion: KMS does not low-S normalize, so normalization here is
